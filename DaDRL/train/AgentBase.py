...
class AgentBase:
    def __init__(self, net_dim: int, state_dim: int, action_dim: int, gpu_id: int, args=None):
        """initialize
    ...
    def explore_one_env(self, env, horizon_len: int, random_exploration=None):
        """
        ...
        self.state[0] = state
        last_dones[0] = i
        return self.convert_trajectory(traj_list, last_dones), rewards  # traj_list
